...
<link href='css/common.css' rel='stylesheet'/>
		...
		<body marginwidth="0" marginheight="0">
			<form method='get' action='bill_changephp_income.php' id='Form'>				
			<?php
					...
					<div class='row'>
						...
						<div class='col-md-12'>
							...
							<div class='box box-primary'>
								<!-- /.box-header -->
								<h3><span>收款情况修改表</span></h3>
								<table>
									<tr>
									
										<td class='datab-1 tdtitle'>收款金额</td>
										<td class='datab-2'><textarea class='txtarea' name='ysk' >{$row['jshj']}</textarea></td>
							
										<td class='datab-1 tdtitle'>凭证号</td>
										<td class='datab-2'><textarea class='txtarea' id='pzh' name='pzh' >{$row['pzh']}</textarea></td>
										<td class='datab-1 tdtitle'>收款日期</td>
									...
									<a href='javascript:;' id='ok' class='easyui-linkbutton l-btn l-btn-small l-btn-plain' onclick='subForm();' ><span class='l-btn-left l-btn-icon-left'><span class='l-btn-text'>修改</span><span class='l-btn-icon icon-ok'>&nbsp;</span></span></a>
										<a href='bill_income.php?htbh=$htbh' id='exit' class='easyui-linkbutton l-btn l-btn-small l-btn-plain' ><span class='l-btn-left l-btn-icon-left'><span class='l-btn-text'>返回</span><span class='l-btn-icon icon-exit'>&nbsp;</span></span></a>
										</center>
										</td>
									</tr>			
									</table>
				...
				layer.open({
					       ...
					       anim: 2,
					       shadeClose: true,
					       content: '<center><h4 style="padding:5px5px;magin:2px;">是否更改收入情况信息</h4></center>',
					       btn: ["确定", "取消"],
					       yes: function () {
					                          $("#Form").submit();
					                       },
