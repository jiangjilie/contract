...
<link href='css/common.css' rel='stylesheet'/>
		...
		<body marginwidth="0" marginheight="0">
			<form method='get' action='bill_changephp_spend.php' id='Form'>
			<?php
						...
						<div class='col-md-12'>
							...
							<div class='box box-primary'>
								...
								<table>
									...
									<td class='datab-1 tdtitle'>付款日期</td>
								...
								<tr>	
									...
									<a href='javascript:;' id='ok' class='easyui-linkbutton l-btn l-btn-small l-btn-plain' onclick='subForm();' ><span class='l-btn-left l-btn-icon-left'><span class='l-btn-text'>修改</span><span class='l-btn-icon icon-ok'>&nbsp;</span></span></a>
										<a href='bill_spend.php?htbh=$htbh' id='exit' class='easyui-linkbutton l-btn l-btn-small l-btn-plain' ><span class='l-btn-left l-btn-icon-left'><span class='l-btn-text'>返回</span><span class='l-btn-icon icon-exit'>&nbsp;</span></span></a>
										</center>
										</td>
									</tr>			
									</table>
