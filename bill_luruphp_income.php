...
<html>
	...
	<body>
				...
				mysql_query($update);
				 //更新income数据
				$update = "update income set ysk='$iysk',gsk='$igsk',date='$kprq' where  htbh='$htbh'";
				mysql_query($update);
				
						 
				// insert语句（插入bill数据，新增）
				$insert = "insert into bill (htbh,xmbh,xmmc,jfdw,htmc,jshj,pzh,kprq,ishtlx,number,bz,isxs) values('$htbh','$xmbh','$xmmc','$dwmc','$htmc','$je','$pzh','$kprq','1','$number','$bz','1')";
