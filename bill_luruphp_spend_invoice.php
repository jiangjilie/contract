...
<html>
	...
	<body>
				...
				$insert = "insert into bill (htbh,xmbh,xmmc,jfdw,htmc,yfk,ysk,pzh,kprq,ishtlx,number,bz,isxs) values('$htbh','$xmbh','$xmmc','$dwmc','$htmc','$je','$se','$pzh','$kprq','2','$number','$bz','1')";
				$res_insert = mysql_query($insert);
				// spend表
				$sql="select ysp,se from spend where htbh='$htbh' ";
				...
				// mysql_query($update);
				 ...
				 // 更新spend
				$update = "update spend set ysp='$syfk',se='$se',date='$kprq' where  htbh='$htbh'";
				 mysql_query($update);
