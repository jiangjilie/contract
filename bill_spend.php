...
<html>
	...
	<!-- 	<link href="css/font-awesome.min.css" rel="stylesheet"/>
		...
		<body marginwidth="0" marginheight="0">
			...
			<form method='get' action='bill_luruphp_spend.php' id='Form'>
				<?php
		...
		<script>
			function ShowEdit(id){
				var iid = id;
				 window.location.href="bill_change_spend.php?user=<?php echo $user;?>&id=" + iid + "";
				}
		</script>
		<script>
				function ShowDel(id) {					
						layer.open({
						 ...
						 yes: function () {
						                     var iid = id;
						                     window.location.href="bill_delete_spend.php?user=<?php echo $user;?>&id=" + iid + "";
						                 },
						});
					}		
			</script>
