	...
	<?php
	 ...
	 <center><h4 style='color:red;padding:5px5px;magin:2px;'>确定删除以下</h4></center>
		...
		<tr id="dwmc">
			...
			<td ><input type="text" style="width:  400px;border: 0;" name="dwmc" value="<?php echo $dwmc;?>" readonly></td>
		</tr>
		...
		<tr id="fkpz">
			<td style='height:30px;width:65px;text-align:center'>付款凭证:</td>
			<td ><input type="text"  style="width:  400px;border: 0;" name="fkpz" value="<?php echo $fkpz;?>" readonly></td>
		</tr>
		</table>
		...
		if($dwmc==''){
			echo" <script> document.getElementById('dwmc').style.display='none';</script>";
		}
		if($htmc==''){
		...
		if($fkpz==''){
			echo" <script> document.getElementById('fkpz').style.display='none';</script>";
		}
		?>
