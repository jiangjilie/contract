						  ...
						  <div class='box box-primary'>
							 ...
							 <table>
							   <tr>
							 	 ...
							 	 <td class='datab-2'><select name='setting[lb]' style='width: 100%;height: 60%; color:black' value='{$row['lb']}'>
							 	  ...
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[pzh]'>{$row['pzh']}</textarea></td>
							 	  ...
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[fgld]'>{$row['fgld']}</textarea></td>
							 	  <td class='datab-1 tdtitle'>开票申请人</td>
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[sqr]'>{$row['sqr']}</textarea></td>
							   
							 	  <td class='datab-1 tdtitle'>发票种类</td>
							 	  <td class='datab-2'><select name='setting[fpzl]' style='width: 100%;height: 60%; color:black' value='{$row['fpzl']}'>
								  ...
								  <tr>
							 	  ...
							 	  <td class='datab-2'><textarea class='txtarea' id='sl' onkeyup='slc()' name='setting[sl]'>{$row['sl']}</textarea></td>
							 	  <td class='datab-1 tdtitle'>发票号码</td>
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[fphm]'>{$row['fphm']}</textarea></td>
							   
							 	  <td class='datab-1 tdtitle'>开票单位</td>
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[kpdw]'>{$row['kpdw']}</textarea></td>
								  </tr>
								  <tr>
							 	  <td class='datab-1 tdtitle'>开票内容</td>
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[kpnr]'>{$row['kpnr']}</textarea></td>
							 	  <td class='datab-1 tdtitle'>发票内容</td>
							 	  <td class='datab-2'><textarea class='txtarea' name='setting[fpnr]'>{$row['fpnr']}</textarea></td>
							   
							 	  <td class='datab-1 tdtitle'>金额</td>
							 	  <td class='datab-2'><textarea class='txtarea' id='je' name='setting[je]' onkeyup='money()'>{$row['je']}</textarea></td>
								  </tr>
								  ...
								  <tr>
							 		...
							 		<td class='datab-2'><textarea class='txtarea' id='se' name='setting[se]'onkeyup='money()'>{$row['se']}</textarea></td>
									<td style='display:none' class='datab-1 tdtitle'>原税额</td>
									<td style='display:none' class='datab-2'><textarea class='txtarea' id='yse' name='setting[yse]'>{$row['se']}</textarea></td>
							 		<td class='datab-1 tdtitle'>价税合计</td>
							 		<td class='datab-2'><textarea class='txtarea' id='jshj' name='setting[jshj]'>{$row['jshj']}</textarea></td>
							 			<td class='datab-1 tdtitle'>合同编号</td>
							 			<td class='datab-2'><textarea class='txtarea' id='htbh' name='setting[htbh]'>{$row['htbh']}</textarea></td>	  	  
							  ...
							  <tr>
							 	  ...
							 	  <td class='datab-2'><textarea class='txtarea' id='xmbh'name='setting[xmbh]'>{$row['xmbh']}</textarea></td>
							
							 	
							
							 	  <td class='datab-1 tdtitle'>备注</td>
							 	  <td class='datab-2' ><textarea class='txtarea' name='setting[bz]'>{$row['bz']}</textarea></td>
							   </tr>  
								<tr style='display:none;'>
									<td>user</td>
