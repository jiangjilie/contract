				...
				<script src="Content/jquery-1.10.2.min.js"></script>
						...
						$("#button").click(function(){
							 $('#tb_user').bootstrapTable('destroy'); //动态加载表格之前，先销毁表格
								...
								var kpdw = $("#kpdw").val();
								var pzh = $("#pzh").val();
								var search= "xmmc=" + xmmc + "&xmbh=" + xmbh + "&jfdw=" + jfdw + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf + "&kpdw=" + kpdw + "&pzh=" + pzh ;
									$.ajax({
								...
								//修改
									function ShowEdit(id,){
										layer.open({
											 ...
											 closeBtn: 1,
											 anim: 2,
											 content: "invoice_change.php?id=" + id ,
											  // btn: ["", "取消"],
										...
										function ShowImg(htbh,xmbh,xmmc,jfdw,htmc){
											 ...
											 // window.location.href="image.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&jfdw=" + jfdw + "&htmc=" + htmc + "&htbh=" + htbh  ;
											}
										function up_image(){
											layer.open({
											 type: 2,
								...
								<script>
									...
									<script>
												function del() {
													...
													var kpdw = $("#kpdw").val();
													var pzh = $("#pzh").val();
													 if(htbh=="" &&  xmbh=="" && xmmc=="" && jfdw=="" && htmc=="" && nd=="" && yf==""&& kpdw==""&& pzh==""){
															layer.open({
															 type: 2,
															 ...
															 offset:'t',  //设置弹出位置
															 shadeClose: true,
															 content: 'delete_invoice.php?xmmc=' + xmmc + '&xmbh=' + xmbh + '&jfdw=' + jfdw + '&htmc=' + htmc + '&htbh=' + htbh + '&nd=' + nd + '&yf=' + yf + '&kpdw=' + kpdw+ '&pzh=' + pzh ,
															 ...
															 yes: function (index, layero) {
																 var thisIndex = index;
																  ...
																  layer.confirm('真的确定清空表中所有数据吗', { icon: 5, title: '提示' }, function (index) {
																		window.location.href= "delete_invoice_php.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&jfdw=" + jfdw + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf + "&kpdw=" + kpdw + "&pzh=" + pzh ;										                                									                 
																																							});
																							},//layer嵌套  *****重要
																		});
																		}else{
							...
							<script>
								function excel(){
									...
									var kpdw = $("#kpdw").val();
									var pzh = $("#pzh").val();
									window.location.href= "excel_invoice.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&jfdw=" + jfdw + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf + "&kpdw=" + kpdw + "&pzh=" +pzh ;
													// layer.open({
													//  type: 2,
													//  skin: 'layui-layer-demo',
													//   area: ['1200px', '300px'],
