...
<html>
	<head>
		...
		<input type="text" value="<?php echo $user; ?>" style="display: none;" id="user">
			<div class="col-sm-12">
			     <div class="box box-primary">
			         <div class="panel-body form-horizontal">					
						<form method="get" action="purchase.php" id="Form">
			              <fieldset>
			                  <div class="form-group">	                           
			              		 <div class="col-sm-2" style="width:106px">
									<span class="form-control" style="border:0px;">
			              		   ...
			              		   <div class="col-sm-2">
			              		       <input type="text" id="xmbh" class="form-control" id="xmbh" name="xmbh" value="<?php echo $xmbh;?>">
			              		   </div>
			                     ...
			                     <div class="col-sm-2" style="width:106px">
			                      ...
			                      <div class="col-sm-2">
			                          <input type="text" id="xmmc" class="form-control" id="xmmc" name="xmmc" value="<?php echo $xmmc;?>">
			                      </div>
								    <div class="col-sm-1"></div>
									<div class="col-sm-2" style="width:106px">
																		<span class="form-control" style="border:0px;">
									 ...
									 <div class="col-sm-2">
									     <input type="text" id="dwmc" class="form-control"  id="dwmc"name="dwmc" value="<?php echo $dwmc;?>">
									 </div>
								 </div>
								 <div class="form-group">
									 <div class="col-sm-2" style="width:106px;display: none;">
									 	<span class="form-control" style="border:0px;">
									 		合同名称
									 	</span>
									 </div>			                     
									 <div class="col-sm-2"style="display: none;">
									 	<input type="text" id="htmc" class="form-control"  id="htmc" name="htmc" value="<?php echo $htmc;?>">
									 </div>
									<!-- <div class="col-sm-1"></div> -->
								  <div class="col-sm-2" style="width:106px">
								  	<span class="form-control" style="border:0px;">
								   ...
								   <div class="col-sm-2">
								       <input type="text" id="nd" class="form-control" id="nd" name="nd" value="<?php echo $nd;?>">
								   </div>
								   <div class="col-sm-1"></div>
								   <div class="col-sm-2" style="width:106px;display: none;">
										<span class="form-control" style="border:0px;">
								    ...
								    <div class="col-sm-2"style="display: none;">
								        <input type="text" id="yf" class="form-control"  id="yf" name="yf" value="<?php echo $yf;?>">
								    </div>
									<div class="col-sm-2" style="width:106px">
										<span class="form-control" style="border:0px;">
									       开始时间
			              ...
			              <fieldset>
			                  <div class="form-group">
			                      <div  style="float: right;">
									 ...
									 <a href="jabascript:;" id="add" title="添加采购合同信息" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-add" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">添加采购</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a>										
									<a href="javascript:;" id="import" title="点击导入记录" onclick="inportExcel()" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-import" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">导入采购</span><span class="l-btn-icon icon-import">&nbsp;</span></span></a>									
									...
									<div class="btn-group dropup">
											...
											<ul class="dropdown-menu" role="menu">
												<li ><a href="javascript:;"title="删除查询数据"onclick="del()" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-cancel" plain="true" group="" id=""><span class="l-btn-left-1 l-btn-icon-left"><span class="l-btn-text-1">删除查询数据</span></span></a></li>
												<!-- <li class="divider"></li> -->
												<li><a href="javascript:;"title="删除选中数据" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-cancel" plain="true" group="" id="remove"><span class="l-btn-left-1 l-btn-icon-left"><span class="l-btn-text-1">删除选中数据</span></span></a></li>
											</ul>
										</div>						
			...
			<table style="word-break:break-all; word-wrap:break-all;" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%"id="tb_user" >
				...
				<tr>
					<td colspan='11' style="text-align:center;">表中无数据存在！</td>
				</tr>
				</table>
				...
				<script>
					...
					$("#add").click(function(){
						...
						layer.open({
							 ...
							 closeBtn: 1,
							 anim: 2,
							 content: "purchase_luru.php?user="+user,
							  // btn: ["", "取消"],
				...
				$("#button").click(function(){
					 $('#tb_user').bootstrapTable('destroy'); //动态加载表格之前，先销毁表格
						...
						var search= "xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&nd=" + nd + "&yf=" + yf+ "&begin=" + begin + "&finish=" + finish ;
							$.ajax({
							...
							success:function(msg){
											...
											var   data = eval("("+msg+")"); //将返回的json数据进解析，并赋给data									
												...
												function excel_select(ids) {
													window.location.href= "excel_purchase_select.php?id=" + ids ;
															}
												...
												function excel_select_detail(ids) {
													window.location.href= "excel_purchase_detail_select.php?id=" + ids ;
															}
						...
						//修改
							function ShowEdit(id){
								layer.open({
									 ...
									 closeBtn: 1,
									 anim: 2,
									 content: "purchase_change.php?id=" + id ,
									  // btn: ["", "取消"],
								...
								//  window.location.href="purchase_change.php?user=<?php echo $user;?>&id=" + id + "&ysk=" + ysk;
								}
						...
						var yf = $("#yf").val();
						 if(  xmbh=="" && xmmc=="" && dwmc=="" && htmc=="" && nd=="" && yf==""){
								layer.open({
								 ...
								 offset:'t',  //设置弹出位置
								 shadeClose: true,
								 content: 'delete_purchase.php?xmmc=' + xmmc + '&xmbh=' + xmbh + '&dwmc=' + dwmc + '&htmc=' + htmc +  '&nd=' + nd + '&yf=' + yf,
								 ...
								 yes: function (index, layero) {
									 var thisIndex = index;
									   ...
									   layer.confirm('<h4 style="color:red;padding:5px5px;magin:2px;">警告：真的确定清空表中所有数据吗</h4></center>', { icon: 5, title: '提示' }, function (index) {
											window.location.href= "delete_purchase_php.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&nd=" + nd + "&yf=" + yf ;										                                									                 
																																});
																},//layer嵌套  *****重要
											});
											}else{
	...
	<script>
		function excel(){
			...
			var begin = $("#begin").val();
			var finish = $("#finish").val();
			window.location.href= "excel_purchase.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc +  "&nd=" + nd + "&yf=" + yf +"&begin=" + begin+"&finish=" + finish ;
							// layer.open({
							//  type: 2,
							//  skin: 'layui-layer-demo',
							//   area: ['1200px', '300px'],
	...
	<script>
		function ifram(){
			...
			var nd = $("#nd").val();
			var yf = $("#yf").val();
			window.location.href= "purchase.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc +  "&nd=" + nd + "&yf=" + yf + "";
		}
	</script>
	<script>
	function inportExcel(){		
			layer.open({
			 type: 2,
			 title:'<center><h3> 零星采购数据导入</center>',
			 // title:false,
			 // maxmin: false,
			 shade: [0.5, '#000'],
			 //配置遮罩层颜色和透明度
