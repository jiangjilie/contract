...
<html>
			...
			<table style="word-break:break-all; word-wrap:break-all;" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%"id="tb_user" >
				...
				$("#button").click(function(){
					 $('#tb_user').bootstrapTable('destroy'); //动态加载表格之前，先销毁表格
						...
						var nd = $("#nd").val();
						var yf = $("#yf").val();
						var search= "xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&nd=" + nd + "&yf=" + yf ;
							$.ajax({
	...
	<script>
		function excel(){
			...
			var nd = $("#nd").val();
			var yf = $("#yf").val();
			window.location.href= "excel_purchase.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc +  "&nd=" + nd + "&yf=" + yf + "";
							// layer.open({
							//  type: 2,
							//  skin: 'layui-layer-demo',
							//   area: ['1200px', '300px'],
