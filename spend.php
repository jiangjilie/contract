		...
		<script>
			...
			$("#add").click(function(){
				...
				layer.open({
					 ...
					 closeBtn: 1,
					 anim: 2,
					 content: "spend_luru.php?user="+user,
					  // btn: ["", "取消"],
		...
		$("#button").click(function(){
									...
									var   data = eval("("+msg+")"); //将返回的json数据进解析，并赋给data									
										...
										width:150,
										                        formatter: function (value, row, index) {//这里的三个参数：value表示当前行当前列的值；row表示当前行的数据；index表示当前行的索引（从0开始）。
																	...
																	'<img class="GridTopImg" title="点击编辑修改条记录" onclick="ShowEdit('+row.id+',\''+row.yfk+'\',\''+row.ysp+'\')" src="images/Edit.png">'+
										...
										function excel_select(ids) {
											window.location.href= "excel_spend_select.php?id=" + ids ;
													}
										...
										function excel_select_detail(ids) {
											window.location.href= "excel_spend_detail_select.php?id=" + ids ;
													}
				...
				//修改
					function ShowEdit(id,yfk,ysp){
						...
						layer.open({
							 ...
							 closeBtn: 1,
							 anim: 2,
							 content: "spend_change.php?id=" + id + "&yfk=" + yfk+"&ysp="+ysp+"&user=" + user,
							  // btn: ["", "取消"],
			...
			<script>
				function excel(){
					...
					var begin = $("#begin").val();
					var finish = $("#finish").val();
					// url= "spend_excel.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf +"&begin=" + begin+"&finish=" + finish ;
					// window.open(url, "_blank");
					window.location.href= "excel_spend.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf + "&begin=" + begin+"&finish=" + finish ;
					...
					function excel_detail(){
						...
						// url= "spend_excel.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf +"&begin=" + begin+"&finish=" + finish ;
						// window.open(url, "_blank");
						window.location.href= "excel_spend_detail_search.php?xmmc=" + xmmc + "&xmbh=" + xmbh + "&dwmc=" + dwmc + "&htmc=" + htmc + "&htbh=" + htbh + "&nd=" + nd + "&yf=" + yf +"&begin=" + begin+"&finish=" + finish ;
									}
