		    ...
		    <div class="row">
		        ...
		        <div class="col-md-12">
		            ...
		            <div class="box box-primary">
		                <!-- /.box-header -->
		                <h3><span>支付合同录入表</span></h3>
		                <table>
									<tr>
									    <td class="datab-1 tdtitle">合同编号</td>
									    <td class="datab-2"><textarea class="txtarea" id='htbh'name="htbh"></textarea></td>
										...
										<tr>
											<td class="datab-1 tdtitle">乙方单位</td>
											...
											<td class="datab-2"><textarea class="txtarea"id="lxr" name="lxr"></textarea></td>				
										</tr>
										<tr>
											...
											<td class="datab-2"><textarea class="txtarea"id="htgq" name="htgq"></textarea></td>
											<td class="datab-1 tdtitle">付款方式</td>
											<td class="datab-2"><textarea class="txtarea" id="fkfs"name="fkfs"></textarea></td>
										</tr>
										<tr>
											
											<td class="datab-1 tdtitle">结算方式</td>
											<td class="datab-2"><textarea class="txtarea"id="jsfs" name="jsfs"></textarea></td>
										...
										<tr>
											...
											<td class="datab-2"><textarea class="txtarea" name="ysp" onclick='addy()' id="ysp" ></textarea></td>
											<td class="datab-1 tdtitle">税额</td>
											<td class="datab-2"><textarea class="txtarea" name="se" id="se"onclick='addy()' ></textarea></td>
											
										</tr>
										<tr style='display:none;'>
											<td class="datab-1 tdtitle">合同主要内容</td>
											<td class="datab-2" colspan="5"><textarea class="txtarea" id="htnr"name="htnr"></textarea></td>
				
										</tr>
				
										<tr>
											<td class="datab-1 tdtitle">备注</td>
											<td class="datab-2" colspan="5"><textarea class="txtarea" id="bz"name="bz"></textarea></td>
										</tr>  
										<tr>
													...
													success: function(data){
														if(data==1){
																...
																layer.open({
																					 ...
																					 closeBtn: 1,
																					 anim: 2,
																					 content: "spend_change_htbh.php?htbh="+htbh,
																					  // btn: ["", "取消"],
				...
				<script>
					function add(){
						...
						layer.open({
						 ...
						 // end:function(){
						 // 	window.location.href="spend_luru.php?htbh="+htbh+"&xmbh="+xmbh+"&xmmc="+xmmc+"&dwmc="+dwmc+"&htmc="+htcm+"&htlx="+htlx+"&lxr="+lxr+"&qdsj="+qdsj+"&htgq="+htgq+"&fkfs="+fkfs+"&jsfs="+jsfs+"&htze="+htze+"&bz="+bz;
						 // },
							// },
							 });
					}
