...
if (copy($tmp, $filename)) {
 ...
 require_once 'PHPExcel/Reader/Excel5.php';
  ...
  require_once 'PHPExcel/Shared/Date.php';
   ...
   $sql = "insert into invoice (nd,yf,lb,pzh,kprq,fgld,sqr,fpzl,sl,fphm,kpdw,kpnr,fpnr,je,se,jshj,bz,htbh,xmbh,xmmc,jfdw,htmc) values ('{$strs[0]}','{$strs[1]}','{$strs[2]}','{$strs[3]}','$time','{$strs[5]}','{$strs[6]}','{$strs[7]}','{$strs[8]}','{$strs[9]}','{$strs[10]}','{$strs[11]}','{$strs[12]}','{$strs[13]}','{$strs[14]}','{$strs[15]}','{$strs[16]}','{$strs[17]}','{$strs[18]}','{$strs[19]}','{$strs[20]}','{$strs[21]}') ON DUPLICATE KEY UPDATE nd='{$strs[0]}',yf='{$strs[1]}',lb='{$strs[2]}',pzh='{$strs[3]}',kprq='$time',fgld='{$strs[5]}',sqr='{$strs[6]}',fpzl='{$strs[7]}',sl='{$strs[8]}',fphm='{$strs[9]}',kpdw='{$strs[10]}',kpnr='{$strs[11]}',fpnr='{$strs[12]}',je='{$strs[13]}',se='{$strs[14]}',jshj='{$strs[15]}',bz='{$strs[16]}',htbh='{$strs[17]}',xmbh='{$strs[18]}',xmmc='{$strs[19]}',jfdw='{$strs[20]}',htmc='{$strs[21]}'";
